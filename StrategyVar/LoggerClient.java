...
//Escribiendo a archivos con fiabilidad de hilos
    ...
    eLogger.log("log4.txt","Este mensaje usará cifrado Caesar y será registrado en el archivo log4.txt");
    logger.log("log4.txt","***********************************************************************");
    ...
    //Escribiendo salidas a consola
	    ...
	    eLoggerC.log("consola","Este mensaje usará cifrado Caesar y será registrado en el archivo log4.txt");
  }
